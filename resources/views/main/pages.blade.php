                                ...
                                <div class="shopping-cart-list">
                                    <div class="product product-widget">
                                        <div class="product-thumb">
                                            <img src="{{asset('main/./img/thumb-product01.jpg')}}" alt="">
                                        </div>
                            ...
                            <div class="row hidden-sm hidden-xs">
                                <div class="col-md-12">
                                    ...
                                    <a class="banner banner-1" href="#">
                                        <img src="{{asset('main/./img/banner05.jpg')}}" alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 hidden-sm hidden-xs">
                                    <a class="banner banner-2" href="#">
                                        <img src="{{asset('main/./img/banner04.jpg')}}" alt="">
            ...
            <div class="menu-nav">
                ...
                <ul class="menu-list">
                    ...
                    <li class="dropdown default-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Pages <i class="fa fa-caret-down"></i></a>
                        <ul class="custom-menu">
                            <li><a href="{{asset('main/index.html')}}">Home</a></li>
                            <li><a href="{{asset('main/products.html')}}">Products</a></li>
                            <li><a href="{{asset('main/product-page.html')}}">Product Details</a></li>
                            <li><a href="{{asset('main/checkout.html')}}">Checkout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-6">
                    <div id="product-main-view">
                        <div class="product-view">
                            <img src="{{asset('main/./img/main-product01.jpg')}}" alt="">
                        </div>
                        <div class="product-view">
                            <img src="{{asset('main/./img/main-product02.jpg')}}" alt="">
                        </div>
                        <div class="product-view">
                            <img src="{{asset('main/./img/main-product03.jpg')}}" alt="">
                        </div>
                        <div class="product-view">
                            <img src="{{asset('main/./img/main-product04.jpg')}}" alt="">
                        </div>
                    </div>
                    <div id="product-view">
                        <div class="product-view">
                        ...
                        <div class="product-view">
                            <img src="{{asset('main/./img/thumb-product02.jpg')}}" alt="">
                        </div>
                        <div class="product-view">
                            <img src="{{asset('main/./img/thumb-product03.jpg')}}" alt="">
                        </div>
                        <div class="product-view">
                            <img src="{{asset('main/./img/thumb-product04.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
